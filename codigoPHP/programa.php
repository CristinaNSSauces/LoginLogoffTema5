<?php
    ...
    */
    ...
    if (!isset($_SESSION['CodUsuario'])) {//Si el usuario no se ha autentificado
...
<html>
    ...
    <body>
        <?php
            ...
            ?>  
                    <h3><?php echo $_COOKIE['saludo'].": ".$_SESSION['CodUsuario']; //Mostramos el saludo del español?></h3>
            ...
            ?>   
                    <h3><?php echo $_COOKIE['saludo'].": ".$_SESSION['CodUsuario']; //Mostramos el saludo del ingles?></h3>
            ...
            ?>   
                    <h3><?php echo $_COOKIE['saludo'].": ".$_SESSION['CodUsuario']; //Mostramos el saludo del frances?></h3>
                    <h3>Langage: <?php echo $_COOKIE['idioma']; //Mostramos el idioma seleccionado en francés?></h3>
            <?php
                }
            }else{
        ?>
                <h3>Hola: <?php echo $_SESSION['CodUsuario']; //Por defecto el saludo en español?></h3>
        <?php
            }
        ?>
